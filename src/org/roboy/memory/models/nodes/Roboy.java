 ...
 * and retrieve information about RoboyModel.
 */
public class Roboy extends MemoryNodeModel {
    public final static RandomList<Neo4jRelationship> VALID_NEO4J_RELATIONSHIPS = new RandomList<>(Neo4jRelationship.MEMBER_OF, Neo4jRelationship.HAS_HOBBY, Neo4jRelationship.FRIEND_OF, Neo4jRelationship.FROM, Neo4jRelationship.LIVE_IN, Neo4jRelationship.CHILD_OF, Neo4jRelationship.SIBLING_OF);

    /**
     * Initializer for the RoboyModel node
     */
    ...
    /**
     * Default initializer for the RoboyModel node
     */
     ...
     * is in sync with memory and represents the RoboyModel itself.
     *
     * If something  goes wrong during querying, RoboyModel stays empty
    ...
    private void InitializeRoboy(String name) {
        ...
        //
            ...
            try {
                ...
                logger.error("Cannot retrieve or find RoboyModel in the Memory. Go the amnesia mode");
    ...
    /**
     * Method to obtain the name of the RoboyModel node
    ...
    /**
     * Method to obtain the specific type relationships of the RoboyModel node
     * @return ArrayList<Integer> ids - list containing integer IDs of the nodes
     * related to the RoboyModel by specific relationship type as in the Memory
     */
    ...
    /**
     * Adds a new relation to the RoboyModel node, updating memory.
     */
    public void addInformation(Neo4jRelationship relationship, String name) {
        ...
        //Update the RoboyModel node in memory.
        try{
            memory.save(this);
        } catch (InterruptedException | IOException e) {
